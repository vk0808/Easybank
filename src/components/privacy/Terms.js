  ...
  return (
    <div className="privacy">
      ...
      <p>
        ...
        of Easybank's Website, located at easybank.in.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Easybank website if you do not agree
      ...
      <p>
        ...
        to use cookies in agreement with the Easybank's Privacy Policy.{" "}
      </p>
      ...
      <p>
        ...
        intellectual property rights for all material on Easybank website. All
        intellectual property rights are reserved. You may access this from
        Easybank website for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Easybank website</li>
        <li>Sell, rent or sub-license material from Easybank website</li>
        <li>Reproduce, duplicate or copy material from Easybank website</li>
        <li>Redistribute content from Easybank website</li>
      </ul>
      ...
      <p>
        ...
        Easybank does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Easybank,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, Easybank shall not be liable
      ...
      <p>
        Easybank reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Easybank a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Easybank; and (d) the link is
      ...
      <p>
        ...
        e-mail to Easybank. Please include your name, your organization name,
      ...
      <p>
        No use of Easybank's logo or other artwork will be allowed for linking
